            ...
            <div class="centent">
                <form name="signup_form" id="signup_form" action="" method="POST">
                    <div class="content_text">
                        <span style="font-weight: bold; color:gray;line-height: 1.3; ">친구들의 사진과 동영상을 보려면 가입하세요</span>
                    </div>
                    <br />
                    ...
                    <div class="input_value" style="margin-top: 12px; margin-bottom: 12px; font-size:12px;line-height: 1.3;">
